    ...
    <div style="width: 600px;position:relative;">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="联系方式" prop="contactsPhone">
          <el-input v-model="ruleForm.contactsPhone" placeholder="请输入联系方式"></el-input>
        </el-form-item>
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          formObj.date1 = parseTime(this.ruleForm.date1, '{y}-{m}-{d}')
          formObj.date2 = parseTime(this.ruleForm.date2, '{h}:{i}:{s}')
          console.log(formObj)
        } else {
